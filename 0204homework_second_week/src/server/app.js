...
app.use(serve(__dirname + '/assets')); //app.use(serve(config.staticDir));
//dirname加上所在文件夹名称
...
const logger = log4js.getLogger('cheese'); //errorHandler容错要写到路由前面

errorHandler.error(app, logger);

require('./controllers')(app); // app.listen(3000,() => {
//   console.log('服务已启动');
// });
